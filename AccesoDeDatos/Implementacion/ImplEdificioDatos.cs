...
namespace AccesoDeDatos.Implementacion
{
    public class ImplEdificioDatos
    {
        ...
        public IEnumerable<tb_edificio> ListarRegistros(string filtro, int paginaActual, int numRegistrosPorPagina, out int totalRegistros)
        {
            ...
            using (InventarioUdCDBEntities bd = new InventarioUdCDBEntities())
            {
                ...
                lista = (from m in bd.tb_edificio
