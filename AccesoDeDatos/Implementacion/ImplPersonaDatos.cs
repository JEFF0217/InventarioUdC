...
namespace AccesoDeDatos.Implementacion
{
    public class ImplPersonaDatos
    {
        ...
        public IEnumerable<tb_persona> ListarRegistros(string filtro, int paginaActual, int numRegistrosPorPagina, out int totalRegistros)
        {
