...
namespace AccesoDeDatos.Implementacion
{
    public class ImplEspacioDatos {
        ...
        public IEnumerable<tb_espacio> ListarRegistros(string filtro, int paginaActual, int numRegistrosPorPagina, out int totalRegistros)
        {
