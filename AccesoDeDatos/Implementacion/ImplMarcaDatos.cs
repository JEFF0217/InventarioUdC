...
namespace AccesoDeDatos.Implementacion
{
    public class ImplMarcaDatos
    {
        ...
        public IEnumerable<tb_marca> ListarRegistros(string filtro, int paginaActual, int numRegistrosPorPagina, out int totalRegistros)
        {
